class AddSecurityOptionsToProfile < ActiveRecord::Migration
  def change
         add_column :users, :is_administrator, :boolean, :default => 0
         add_column :users, :is_data_viewer, :boolean, :default => 1
         add_column :users, :is_data_downloader, :boolean, :default => 1


         add_column :profiles, :secure_administration, :boolean, :default => 1
